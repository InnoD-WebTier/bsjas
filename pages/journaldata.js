	...
	"submit": [
	  {
		  ...
		  "answer": "Each piece of work is evaluated by the following criteria:<span class='p'></span> <ul><li>Originality of work</li> <li>Assertion of a clear and significant argument</li> <li>Quality of the evidence provided to support claims</li> <li>Organization of ideas in guiding readers’ understanding</li> <li>Grammar, syntax, spelling</li></ul> <span class='p'></span> Moreover, while the Journal Committee chooses to evaluate each submission based on several criteria, we also approach and evaluate each entry holistically (particularly for creative works)."
	  }, {
