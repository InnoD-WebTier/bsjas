...
class Journal extends React.Component {
  ...
  render () {
    ...
    const genTabs = () => {
      let tabs = [{ title: 'Spring 2016'}, { title: 'Fall'}, { title: 'c'}];
      ...
      <div className="">
		...
		<div className="journals">
		  ...
		  <div className="tab-content">
		    <h2 className="tab-title">BSJAS Fifth Edition</h2>
			
		  	<div className="author">Vidhatha Reddy</div>
		    <div className="title">Family Patriarchs as Tragic Figures in the Mahabharata and Ramayana</div>
			
			<div className="author">Jinoh (Kahn) Ryu</div>
			<div className="title">Transnational Feminist Approaches to Languages and Identities of East Asian "Third Culture Kids" at UC Berkeley</div>
			
			<div className="author">Grayson Dimick</div>
			<div className="title">Seeking Partnership: The Development of Human Rights in Cambodia since 1993</div>
			
			<div className="author">Ari Shusterman</div>
			<div className="title">The State of Interethnic Relations in Post-Soviet Central Asia: A Cultural, Historical, and Political Perspective</div>
			
			<div className="author">Malayandi Palaniappan</div>
			<div className="title">The Friendship of Karna and Duryodhana in the Mahabharata</div>
			
			<div className="author">Veena Bhatia</div>
			<div className="title">The Ethicality of Chinese Investment in the Democratic Republic of the Congo: The Realist and Cosmopolitan Perspective</div>
		  </div>
		</div>
